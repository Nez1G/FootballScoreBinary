...
public class Client extends Thread{
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            System.out.println("Endereço Desconhecido " + unknownHostException);
            System.exit(-1);
        }
        
        //Cria um socket para establecer uma ligação com o servidor e porta pretendidos
        try{
            System.out.println("A conectar ao servidor");
            connection = new Socket(address, DEFAULT_PORT);
            System.out.println("Conexão establecida com o servidor " + address.getHostName() + " na porta " + DEFAULT_PORT);
        } catch(IOException ioException){
            System.err.println("Erro ao criar a conexão com o servidor...");
        ...
        try{
            ...
            //Fecha a conexão e as streams
            output.close();
            input.close();
            connection.close();
            System.out.println("A conexão foi terminada");
