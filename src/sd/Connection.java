...
public class Connection extends Thread {
    ...
    //Cria um Socket para cada nova ligação e obtém a referência das Streams de entrada e/ou saída
    public Connection(Socket clientConnection, Equipa e){
    ...
    //Lê e escreve no o Socket através de Streams
    public void run(){
        try{
            System.out.println("Conexão establecida com o cliente " + connection.getInetAddress().getHostName() + " na porta " + connection.getPort());
            
            //Lê o pedido feito pelo cliente
            ...
            //CRIA A RESPOSTA DO SERVIDOR
                ...
                if(count == 0){
                    ...
                    // Copia os valores da variáveis da resposta para um único array respostaServidor
              ...
              //ATUALIZA RESULTADO      
                ...
                //Não permite que 2 clientes alterem o resultado do jogo ao mesmo tempo
            ...
            //Envia todos os outputs que estiverem em buffer e fecha a conexão e as streams
            output.flush();
            output.close();
            input.close();
            connection.close();
